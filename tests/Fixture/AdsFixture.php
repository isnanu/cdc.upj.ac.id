...
class AdsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'user_id' => ['type' => 'index', 'columns' => ['user_id', 'ad_category_id'], 'length' => []],
            'user_username' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
    ...
    public $records = [
        [
            ...
            'created' => '2015-08-06 04:01:10',
            'modified' => '2015-08-06 04:01:10'
        ],
    ];
}
